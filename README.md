...
- Change the `bucket` to initialize your state file:
    ```
...
- Change the profile_name for terragunt use your credentials you configured:
    ```
    in project-devops/terraform/aws/us-east-1/infra/account-common.hcl
    ```
...
- To change the region where you will upload your infrastructure, just change the file:
    ```
    in project-devops/terraform/aws/us-east-1/infra/region-common.hcl
    ```
